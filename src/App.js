...
class App extends Component {
    ...
    render() {
        return ( <
            ...
            <
            span className = "iconify language-icon mr-5"
            dataicon = "twemoji-flag-for-flag-united-kingdom"
            datainline = "false"
            ...
            <
            span className = "iconify language-icon"
            dataicon = "twemoji-flag-for-flag-poland"
            datainline = "false"
